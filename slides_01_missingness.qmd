...
![](img/rubin1987_cover.jpeg){fig-align="center" width=30%}
...
## Multiple imputation: Cons

-   Need to create and work with multiple imputed data sets
-   Presumes a fairly well-developed idea of what to estimate
-   May not always be the most statistically efficient method

## Multiple imputation: Pros
...
- Multiple imputation is generally valid, flexible solution for handling incomplete data